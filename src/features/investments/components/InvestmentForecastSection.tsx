  ...
  return (
    <section className="space-y-3">
      ...
      <div className="rounded-xl border bg-card p-4 space-y-4">
        ...
        {/* Final-value summary */}
        <div className="grid grid-cols-3 gap-3 rounded-lg bg-muted/30 px-3 py-2.5 text-center">
          <div>
            ...
            <p className="text-base font-semibold tabular-nums text-emerald-600 dark:text-emerald-400">
              {finalPoint ? formatDecimal(finalPoint.nominal) : '—'}
            </p>
          </div>
          <div>
